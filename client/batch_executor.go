...
type BatchExecutor interface {
	...
	AddInsertOp(rowKey []*table.Column, mutateValues []*table.Column, opts ...option.ObOperationOption) error
	...
	AddIncrementOp(rowKey []*table.Column, mutateValues []*table.Column, opts ...option.ObOperationOption) error
	// AddAppendOp add an append operation to the batch executor
	AddAppendOp(rowKey []*table.Column, mutateValues []*table.Column, opts ...option.ObOperationOption) error
	// AddDeleteOp add a delete operation to the batch executor
	AddDeleteOp(rowKey []*table.Column, opts ...option.ObOperationOption) error
	// AddGetOp add a get operation to the batch executor.
	AddGetOp(rowKey []*table.Column, getColumns []string, opts ...option.ObOperationOption) error
