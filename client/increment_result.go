...
type IncrementResult interface {
	AffectedRows() int64
	Value(columnName string) interface{}
	RowKey() []interface{}
}

func newObIncrementResult(affectedRows int64, affectedEntity *protocol.ObTableEntity) *obIncrementResult {
	return &obIncrementResult{affectedRows, affectedEntity}
}

type obIncrementResult struct {
	affectedRows   int64
	affectedEntity *protocol.ObTableEntity
}

func (r *obIncrementResult) AffectedRows() int64 {
	return r.affectedRows
}

func (r *obIncrementResult) Value(columnName string) interface{} {
...
func (r *obIncrementResult) RowKey() []interface{} {
	if r.affectedEntity == nil {
		return nil
	}
