...
func TestObSingleOp_String(t *testing.T) {
	...
	assert.Equal(t, "obSingleOp{indexOfBatch:0, op:ObTableOperation{ObUniVersionHeader:ObUniVersionHeader{version:1, contentLength:0, flag:7, tenantId:1, sessionId:0, timeout:10s, uniqueId:0, sequence:0}, opType:0, entity:ObTableEntity{ObUniVersionHeader:ObUniVersionHeader{version:1, contentLength:0, flag:7, tenantId:1, sessionId:0, timeout:10s, uniqueId:0, sequence:0}, rowKey:RowKey{keys:[ObObject{meta:ObObjectMeta{objType:ObObjType{type:ObInt64Type}, collationLevel:5, collationType:63, scale:10}, value:1}]}, propertiesStr:{m[c2]=ObObject{meta:ObObjectMeta{objType:ObObjType{type:ObInt64Type}, collationLevel:5, collationType:63, scale:10}, value:1}}}}}", op.String())
}
