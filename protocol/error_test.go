...
func TestNewProtocolError(t *testing.T) {
	...
	err := NewProtocolError("127.0.0.1", 8080, error2.ObErrPrimaryKeyDuplicate, sequence, uniqueId, "test")
	assert.EqualError(
		t,
		err,
	...
	err = NewProtocolError("127.0.0.1", 8080, error2.ObErrUnknownTable, sequence, uniqueId, "test")
	assert.EqualError(
		t,
		err,
	...
	err = NewProtocolError("127.0.0.1", 8080, error2.ObErrColumnNotFound, sequence, uniqueId, "test")
	assert.EqualError(
		t,
		err,
	...
	err = NewProtocolError("127.0.0.1", 8080, error2.ObObjTypeError, sequence, uniqueId, "test")
	assert.EqualError(
		t,
		err,
	...
	err = NewProtocolError("127.0.0.1", 8080, error2.ObBadNullError, sequence, uniqueId, "test")
	assert.EqualError(
		t,
		err,
	...
	err = NewProtocolError("127.0.0.1", 8080, error2.ObInvalidArgument, sequence, uniqueId, "test")
	assert.EqualError(
		t,
		err,
	...
	err = NewProtocolError("127.0.0.1", 8080, error2.ObDeserializeError, sequence, uniqueId, "test")
	assert.EqualError(
		t,
		err,
	...
	err = NewProtocolError("127.0.0.1", 8080, error2.ObPasswordWrong, sequence, uniqueId, "test")
	assert.EqualError(
		t,
		err,
	...
	err = NewProtocolError("127.0.0.1", 8080, error2.ObLocationLeaderNotExist, sequence, uniqueId, "test")
	assert.EqualError(
		t,
		err,
	...
	err = NewProtocolError("127.0.0.1", 8080, error2.ObNotMaster, sequence, uniqueId, "test")
	assert.EqualError(
		t,
		err,
	...
	err = NewProtocolError("127.0.0.1", 8080, error2.ObRsNotMaster, sequence, uniqueId, "test")
	assert.EqualError(
		t,
		err,
	...
	err = NewProtocolError("127.0.0.1", 8080, error2.ObRsShutdown, sequence, uniqueId, "test")
	assert.EqualError(
		t,
		err,
	...
	err = NewProtocolError("127.0.0.1", 8080, error2.ObRpcConnectError, sequence, uniqueId, "test")
	assert.EqualError(
		t,
		err,
	...
	err = NewProtocolError("127.0.0.1", 8080, error2.ObPartitionNotExist, sequence, uniqueId, "test")
	assert.EqualError(
		t,
		err,
	...
	err = NewProtocolError("127.0.0.1", 8080, error2.ObPartitionIsStopped, sequence, uniqueId, "test")
	assert.EqualError(
		t,
		err,
	...
	err = NewProtocolError("127.0.0.1", 8080, error2.ObLocationNotExist, sequence, uniqueId, "test")
	assert.EqualError(
		t,
		err,
	...
	err = NewProtocolError("127.0.0.1", 8080, error2.ObServerIsInit, sequence, uniqueId, "test")
	assert.EqualError(
		t,
		err,
	...
	err = NewProtocolError("127.0.0.1", 8080, error2.ObServerIsStopping, sequence, uniqueId, "test")
	assert.EqualError(
		t,
		err,
	...
	err = NewProtocolError("127.0.0.1", 8080, error2.ObTenantNotInServer, sequence, uniqueId, "test")
	assert.EqualError(
		t,
		err,
	...
	err = NewProtocolError("127.0.0.1", 8080, error2.ObTransRpcTimeout, sequence, uniqueId, "test")
	assert.EqualError(
		t,
		err,
	...
	err = NewProtocolError("127.0.0.1", 8080, error2.ObNoReadableReplica, sequence, uniqueId, "test")
	assert.EqualError(
		t,
		err,
	...
	err = NewProtocolError("127.0.0.1", 8080, error2.ObReplicaNotReadable, sequence, uniqueId, "test")
	assert.EqualError(
		t,
		err,
	...
	err = NewProtocolError("127.0.0.1", 8080, error2.ObTimeout, sequence, uniqueId, "test")
	assert.EqualError(
		t,
		err,
		"errCode:-4012, errCodeName:ObTimeout, errMsg:Timeout., server:127.0.0.1:8080, trace:YBC6602FF-0000000000000002, tableName:test",
	)
	err = NewProtocolError("127.0.0.1", 8080, error2.ObTransTimeout, sequence, uniqueId, "test")
	assert.EqualError(
		t,
		err,
	...
	err = NewProtocolError("127.0.0.1", 8080, error2.ObWaitqueueTimeout, sequence, uniqueId, "test")
	assert.EqualError(
		t,
		err,
	...
	err = NewProtocolError("127.0.0.1", 8080, error2.ObErrUnexpected, sequence, uniqueId, "test")
	assert.EqualError(
		t,
		err,
