...
const (
	testUInt32TableName       = "test_uint32"
	testUInt32CreateStatement = "create table if not exists `test_uint32`(`c1` int(12) unsigned not null,`c2` int(12) unsigned default null,primary key (`c1`));"
)

func TestInsertUInt32(t *testing.T) {
	tableName := testUInt32TableName
	defer test.DeleteTable(tableName)

	rowKey := []*table.Column{table.NewColumn("c1", uint32(1))}
	mutateColumns := []*table.Column{table.NewColumn("c2", uint32(1))}
...
func TestUpdateUInt32(t *testing.T) {
	...
	updateColumns := []*table.Column{table.NewColumn("c2", uint32(2))}
...
func TestInsertOrUpdateUInt32(t *testing.T) {
	tableName := testUInt32TableName
	defer test.DeleteTable(tableName)
